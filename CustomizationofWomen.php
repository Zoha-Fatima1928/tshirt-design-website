...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS/womencollection.css" />
        <script src="./Javascript/womencollection.js" defer></script>
    ...
    <?php  require('./Components/HeaderComponent4.php')?>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/Womens/women1.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
        ...
        <button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewwomen.php">Preview Image</a>
            </div>
            <br />
            <br />
        </div>
...
function removeuploadedimage(){
    document.querySelector("#ImageShown").style.display = "none";
}
