...
<html lang="en">
    <head>
        ...
        <title>Kids Romper</title>
        <link rel="stylesheet" href="CSS/Rompers.css" />
        <script src="./Javascript/Rompers.js" defer></script>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/Kids/Hodies/Hodies1.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
 ...
 <div class="Class35" style="margin-top:10px">
        ...
        <button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewRompers.php">Preview Image</a>
             </div>
            <br />
            <br />
        </div>
