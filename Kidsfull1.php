...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS/kidsfull.css" />
        <script src="./Javascript/kidsfull.js" defer></script>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/Kids/Kids21.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
 ...
 <div class="Class35" style="margin-top:10px">
        ...
        <button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewkidsfull.php">Preview Image</a>
                </div>
            </div>
            <br />
            <br />
