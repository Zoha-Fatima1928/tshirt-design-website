...
<body>
    ...
    <div style="display:flex;justify-content:center">
        <div id="textareamovement" ondrop="drop(event)" ondragover="allowDrop(event)">
            <div id="previewText" draggable="true" ondragstart="drag(event)" onmousedown="startDragging(event)"
                onmouseup="stopDragging(event)"></div>
        </div>
    </div>
    <br>
    <div style="display:flex;justify-content:center">
...
<script>
    ...
    // Function to enable dragging of the preview text on click
    ...
    // Function to stop dragging the preview text and perform drop on click if applicable
