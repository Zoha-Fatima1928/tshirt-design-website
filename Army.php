...
<head>
    ...
    <title>Full Sleeves Template</title>
    <link rel="stylesheet" href="./CSS/Army.css">
    <script src="./Javascript/Army.js" defer></script>
...
<div style="display:flex; justify-content:center">
    <div class="CustomizationArea">
      ...
      <div>
        <img id="pic" src="./Images/Army/army1.jpg" width="400px"  style="margin-left:300px ; "/>
      </div>
   ...
   margin-left:40px ; margin-top:-430px ; border-radius:10px">
   <div>
...
<button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewarmy.php">Preview Image</a>
</div>
    </div>
    <br><br>
    <br /><br><br>
