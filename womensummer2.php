...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS/womensummer2.css" />
        <script src="./Javascript/womensummer2.js" defer></script>
    ...
    <?php  require('./Components/HeaderComponent4.php')?>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/Womens/Womens/Summer/fullsleeves/women1.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
        ...
        <button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewwomensummer2.php">Preview Image</a>
            </div>
            <br />
            <br />
        </div>
