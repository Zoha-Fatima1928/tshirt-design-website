...
<head>
    ...
    <link rel="stylesheet" href="CSS/logotemplate.css">
    <script src="./Javascript/logotemplate.js"> </script>
...
<div style="display:flex; justify-content:center">
    <div class="CustomizationArea">
      ...
      <div>
        <img id="pic" src="./Images/template1.jpg" width="400px"  style="margin-left:300px ; "/>
      </div>
...
<button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewlogotemplate1.php">Preview Image</a>
</div>
<br><br>
    </div>
    <br><br>
