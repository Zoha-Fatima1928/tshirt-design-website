...
<html lang="en">
    <head>
        ...
        <title>cwinter</title>
        <link rel="stylesheet" href="CSS/cwinter.css" />
        <script src="./Javascript/cwinter.js" defer></script>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/cwinter1.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
                    ...
                    <div class="DrawingArea" id="imageshow">
                        ...
                        <div style="display: flex; justify-content: center; margin-left: 20px; width: 40x; display: none; margin-top: -90px;" id="inputdiv" contenteditable="true">
                            <input type="text" class="InputTextStyle" maxlength="10" id="input" autofocus="autofocus" placeholder="Text Here" style="margin-top: 3px; width: 150px; margin-left: 15px;" />
                        </div>
                    </div>
                </div>
                ...
                <div class="Class33" style="margin-top:-130px">
                ...
                <a href="./Preview/previewwithcollar.php">Preview Image</a>
            </div>
            <br />
            <br />
        </div>
