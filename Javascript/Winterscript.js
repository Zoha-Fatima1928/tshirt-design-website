...
function change1() {
  document.getElementById("pic").src = "./Images/csummer1.webp";
 
}

function change2() {
  document.getElementById("pic").src = "./Images/csummer2.webp";
}

function change3() {
  document.getElementById("pic").src = "./Images/csummer3.webp";
}

function change4() {
  document.getElementById("pic").src = "./Images/csummer4.webp";
}
function change5() {
  document.getElementById("pic").src = "./Images/csummer5.webp";
}
function change6() {
  document.getElementById("pic").src = "./Images/csummer6.webp";
}
function change7() {
  document.getElementById("pic").src = "./Images/csummer7.webp";
}
function change8() {
  document.getElementById("pic").src = "./Images/csummer8.webp";
}
function change9() {
  document.getElementById("pic").src = "./Images/csummer9.webp";
}
function change10() {
  document.getElementById("pic").src = "./Images/csummer10.webp";
}
function change11() {
  document.getElementById("pic").src = "./Images/csummer11.webp";
}
function change12() {
  document.getElementById("pic").src = "./Images/csummer12.webp";
}
