function change1() {
    document.getElementById("pic").src = "./Images/Womens/women2.webp";
  }
  function change2() {
    document.getElementById("pic").src = "./Images/Womens/women3.webp";
  }
  function change3() {
    document.getElementById("pic").src = "./Images/Womens/women4.webp";
  }
  function change4() {
    document.getElementById("pic").src = "./Images/Womens/women5.webp";
  }
  function change5() {
    document.getElementById("pic").src = "./Images/Womens/women6.webp";
  }
  function change6() {
    document.getElementById("pic").src = "./Images/Womens/women1.webp";
  }
  ...
  function myFunction() {
    ...
    document.getElementById("inputdiv").style =
      "display:flex ; justify-content : center ;  font-size:40px ;  text-align : center ;  font-weight:bolder";
  }
