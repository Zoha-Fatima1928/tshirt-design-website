function change1() {
    document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies2.webp";
  }
  function change2() {
    document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies1.webp";
  }
  function change3() {
    document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies4.webp";
  }
  function change4() {
    document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies5.webp";
  }
  function change5() {
    document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies6.webp";
  }
//   function change6() {
//     document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies7.webp";
//   }
//   function change7() {
//     document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies8.webp";
//   }
//   function change8() {
//     document.getElementById("pic").src = "./Images/Kids/Hodies/Hodies3.webp";
//   }
  ...
  function myFunction() {
    ...
    document.getElementById("inputdiv").style =
      "display:flex ; justify-content : center ;  font-size:40px ;margin-left:10px; text-align : center ; margin-top:-20px";
  }
...
function myFunction() {
  ...
  document.getElementById("inputdiv").innerHTML = x;
  document.getElementById("inputdiv").style = 
  "display:flex ; justify-content : center ;  font-size:40px ; margin-top:-45px  ; text-align : center ; color:blue ; font-weight:bold" ;
}
