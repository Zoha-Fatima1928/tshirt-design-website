function change1() {
    document.getElementById("pic").src = "./Images/Womens/Womens/Summer/shortsleeves2/women2.webp";
  }
  function change2() {
    document.getElementById("pic").src = "./Images/Womens/Womens/Summer/shortsleeves2/women3.webp";
  }
  function change3() {
    document.getElementById("pic").src = "./Images/Womens/Womens/Summer/shortsleeves2/women1.webp";
  }
  ...
  function myFunction() {
    ...
    document.getElementById("inputdiv").style =
      "display:flex ; justify-content : center ;  font-size:25px ; margin-top:10px  ; text-align : center ;  font-weight:bolder ; margin-left:3px";
  }
