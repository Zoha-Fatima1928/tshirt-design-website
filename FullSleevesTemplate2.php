...
<head>
    ...
    <link rel="stylesheet" href="./CSS/Full2.css">
    <script src="./Javascript/Full2.js" defer></script>
...
<div style="display:flex; justify-content:center">
    <div class="CustomizationArea">
      ...
      <div>
        <img id="pic" src="./Images/TEMPLATES/fulla.jpg" width="400px"  style="margin-left:300px ; "/>
      </div>
