...
<head>
    ...
    <link rel="stylesheet" href="./CSS/Full1.css">
    <script src="./Javascript/full1.js" defer></script>
...
<div style="display:flex; justify-content:center">
    <div class="CustomizationArea">
      ...
      <div>
        <img id="pic" src="./Images/TEMPLATES/full1.jpg" width="400px"  style="margin-left:300px ; "/>
      </div>
...
<button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewfull1.php">Preview Image</a>
</div>
    </div>
    <br><br>
    <br /><br><br>
