...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS/kidsummer.css" />
        <script src="./Javascript/kidssummer.js" defer></script>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/Kids/Kids11.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
 ...
 <div class="Class35" style="margin-top:10px">
        ...
        <button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewkidssummer1.php">Preview Image</a>
                </div>
            </div>
            <br />
            <br />
