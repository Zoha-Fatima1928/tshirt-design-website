...
<html lang="en">
    <head>
        ...
        <title>Kids Customization</title>
        <link rel="stylesheet" href="CSS/kidscollection.css" />
        <script src="./Javascript/kidscollection.js" defer></script>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="CustomizationArea">
                ...
                <div style="display: flex; justify-content: center; flex-direction: row;">
                    <div>
                        <img id="pic" src="./Images/Kids/Kids1.webp" width="400px" style="margin-left: 300px;" />
                        <div class="Class6">
                        ...
                        <!-- New Logo -->
                        <div class="Class12">
                            <img id="logo1" src="./Images/Kids/Kidslogo/kids5.png" class="Class13" />
                        </div>
                        <div class="Class12">
                            <img id="logo2" src="./Images/Kids/Kidslogo/kidslogo2.png" class="Class13" />
                        </div>
                        <div class="Class12">
                            <img id="logo3" src="./Images/Kids/Kidslogo/kidslogo3.png" class="Class13" />
                        </div>
                        <div class="Class12">
                            <img id="logo4" src="./Images/Kids/Kidslogo/kids6.png" class="Class13" />
                        </div>
                      </div>
                    <div class="DrawingArea" id="imageshow">
                        ...
                        <div style="display: flex; justify-content: center; margin-left: 20px; width: 40x; display: none; margin-top: -90px;" id="inputdiv" contenteditable="true">
                            <input type="text" class="InputTextStyle" maxlength="10" id="input" autofocus="autofocus" placeholder="Text Here" style="margin-top: 3px;" />
                        </div>
                    </div>
                </div>
                <div style="border: 5px solid gray; width: 300px; height: 150px; margin-left: 40px; margin-top: -380px; border-radius: 10px;">
                    ...
                    <div style="display: flex; justify-content: center; margin-top: -5px;">
                        ...
                        <button id="btn7" onclick="change7()" style="margin-left: 6px;"></button>
                    </div>
                    <br />
 ...
 <div class="Class35" style="margin-top:10px">
                    <div onclick="saveImageSource('logo1');w3.show('#logo1');w3.hide('#super');w3.hide('#triangle');w3.hide('#square');w3.hide('#circle')" class="Class38">
                            <img src="./Images/Kids/Kidslogo/kids5.png" alt="" srcset="" style="width: 40px; height: 40px;" />
                        </div>
                        <div onclick="saveImageSource('logo2');w3.show('#logo2');w3.hide('#logo1');w3.hide('#super');w3.hide('#triangle');w3.hide('#square');w3.hide('#circle')" class="Class38">
                            <img src="./Images/Kids/Kidslogo/kidslogo2.png" alt="" srcset="" style="width: 40px; height: 40px;" />
                        </div>   
                        <div onclick="saveImageSource('logo3');w3.show('#logo3');w3.hide('#logo2');w3.hide('#logo1');w3.hide('#super');w3.hide('#triangle');w3.hide('#square');w3.hide('#circle')" class="Class38">
                            <img src="./Images/Kids/Kidslogo/kidslogo3.png" alt="" srcset="" style="width: 40px; height: 40px;" />
                        </div> 
                        <div onclick="saveImageSource('logo4');w3.show('#logo4');w3.hide('#logo3');w3.hide('#logo2');w3.hide('#logo1');w3.hide('#super');w3.hide('#triangle');w3.hide('#square');w3.hide('#circle')" class="Class38">
                            <img src="./Images/Kids/Kidslogo/kids6.png" alt="" srcset="" style="width: 40px; height: 40px;" />
                        </div> 
                    </div>
</div>
</div>
        ...
        <button id="SaveButton2"  onclick="saveInputValue()">Save Image</button>
                <a href="./Preview/previewkids.php">Preview Image</a>
                </div>
            </div>
            <br />
            <br />
